...
namespace adduo.elephant.repositories.Migrations
{
    ...
    [Migration("20220322031439_debt_amount")]
    partial class debt_amount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("adduo.elephant.domain.entities.debts_template.DebtAmountTemplate", b =>
                {
                    b.HasBaseType("adduo.elephant.domain.entities.debts_template.DebtTemplate");
                    ...
                    b.ToTable("debts_templates_amounts");
                });
            ...
            modelBuilder.Entity("adduo.elephant.domain.entities.debts_template.InstallmentTemplate", b =>
                {
                    b.HasBaseType("adduo.elephant.domain.entities.debts_template.DebtAmountTemplate");
            ...
            modelBuilder.Entity("adduo.elephant.domain.entities.debts_template.DebtAmountTemplate", b =>
                {
                    b.HasOne("adduo.elephant.domain.entities.debts_template.DebtTemplate", null)
                        .WithOne()
                        .HasForeignKey("adduo.elephant.domain.entities.debts_template.DebtAmountTemplate", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("adduo.elephant.domain.entities.debts_template.InstallmentTemplate", b =>
                {
                    b.HasOne("adduo.elephant.domain.entities.debts_template.DebtAmountTemplate", null)
                        .WithOne()
